  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="button-wrapper">
        <a href="${domain}/Resetpassword/user?token=${forgotpasswordtoken}" class="btn"> Reset Password</a>
      </div>
      ...
      <div class="link-box">
        ...
        <a href="${process.env.DOMAIN_NAME}login/forgot-password">Resend Page</a>
      </div>
    </div>
