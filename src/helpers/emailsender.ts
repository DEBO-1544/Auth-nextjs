...
export async function sendEmail(email: string, verifytoken: string, name: string) {
    try {
...
<div style="font-family: inherit; text-align: center"><span style="color: #ffbe00; font-size: 18px"><strong>Thank you!${name}</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
